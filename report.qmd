...
dat %>% 
    ...
    geom_point(aes(x = 1, y = Female), fill = "lightblue", color = "grey",size = 2, shape = 21)+
    geom_point(aes(x = 1.5, y = Male), fill = "lightblue",color = "grey",size = 2, shape = 21)+
    geom_segment(aes(x=1, xend=1.5, y = Female, yend= Male), size = .3, color = "grey")+
    geom_text(aes(x = 1.05, y = 1, label = "Female"))+
    geom_text(aes(x = 1.55, y = 1, label = "Male")) +
...
dat %>% 
    ...
    ggplot(aes(x = m_value, y = country_display, fill = as.factor(year_code)))+
    geom_point(size = 2, shape = 21)+
    geom_line(aes(group = country_display))+
    geom_vline(aes(xintercept = m_value_year), lty = 4, col = "salmon")+
    labs(
        x = "",
        y = "",
