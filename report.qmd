...
dat %>% 
    ...
    geom_point(shape = 21, fill = "lightblue", size = 2,  color = "grey")+
    geom_line(aes(group = country_display), color = "grey")+
...
dat %>% 
    ...
    geom_line(aes(group = country_display), arrow = arrow(length = unit(0.075, "inches")))+
